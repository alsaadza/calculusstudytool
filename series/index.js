...
// Example usage
const csvUrl = 'https://raw.githubusercontent.com/alza244/alza244.github.io/main/series.csv'; // URL of the CSV file
...
if (!isProblem) {
    ...
    if (problem[1].toLowerCase() == userInput.toLowerCase()) {
    	sound.play();
        win++;
